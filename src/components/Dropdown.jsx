...
export const Dropdown = (props) => {
  ...
  return (
    <div class="relative inline-block w-48" ref={dropdownRef}>
      <button 
      ...
      {isOpen() && (
        <ul class="absolute top-full left-0 right-0 bg-white rounded-xl border-black border border-t-0 list-none m-0 p-0 max-h-48 overflow-y-auto z-50" role="listbox">
          {options.map((option) => (
            <li 
